...
public class NotificationTaskService {
    ...
    public void sendNotifications() {
        ...
        List<NotificationEntity> notifications = this.notificationRepository.findNotifications(twoHoursAgo);
        if (notifications != null) {
            for (NotificationEntity notification : notifications) {
                if(notification != null) {
                    ...
                    if (telegramId != null) {
                        telegramBotService.sendMessage(telegramId, subject + "\n" + description + "\n" + text);
                        notification.setIsSent(true);
                    }

                    notificationService.updateNotification(notification.getId(),notificationMapper.toDto(notification));
